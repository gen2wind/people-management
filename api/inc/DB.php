<?php
/**
* This is the DB Function  Class for commonly used functions
*
...
class DB{
    ...
    public function __construct($host=null, $user=null, $pass=null, $dbname=null, $port=null){
        mb_internal_encoding( 'UTF-8' );
        mb_regex_encoding( 'UTF-8' );
        mysqli_report( MYSQLI_REPORT_STRICT );
        try {
            $this->link = new \mysqli( $host ?: DB_HOST, $user ?: DB_USER, $pass ?: DB_PASS, $dbname ?: DB_NAME, $port ?: DB_PORT );
     ...
     */
     ...
     public function quote( $data ){
         if( !is_array( $data ) ){
             ...
             //Self call function to sanitize array data
             $data = array_map( array( $this, 'quote' ), $data );
         }
         return $data;
     }
    ...
    public function exists( $table = '', $check_val = '', $params = array() ){
        ...
        $number = $this->resultNumOfRows( $rs_check );
        if( $number === 0 ){
            return false;
        }
        else{
     ...
     *
     */
    public function fetchOneRow( $query, $object = false ){
        self::$counter++;
     ...
     *
     */
    public function fetchAllRows( $query, $object = false ){
        self::$counter++;
